...
TIMEFRAME_INCREMENTS : [10]i32 : {60, 300, 900, 1800, 3600, 10_800, 21_600, 43_200, 86_400, 604_800}
...
Chart_CreateHTFCandles :: proc(chart : ^Chart)
{
    ...
    for timeframe in Timeframe.MINUTE_5 ..= Timeframe.WEEK
    {
        ...
        timeframeDivisor := int(timeframeIncrements[timeframe] / timeframeIncrements[prevTimeframe])
        ...
        firstCandleComponentCount := timeframeDivisor - int((chart.candles[prevTimeframe].offset - chart.candles[timeframe].offset) / timeframeIncrements[prevTimeframe])
