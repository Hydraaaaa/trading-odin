...
DrawVolumeProfile :: proc(posX : i32, width : i32, cameraPosY : i32, profile : VolumeProfile, scaleData : ScaleData, drawBody : bool = true, drawPoc : bool = true, drawVa : bool = true, drawTvVa : bool = true, drawVwap : bool = true)
{
    if drawBody
    {
